...
description: "Help Litium partner developers build, configure, and deploy e-commerce sites and backoffice UI extensions. Use for React Accelerator (Next.js, GraphQL, blocks, cart, checkout, wishlist), MVC Accelerator (.NET Razor views, controllers, view models, client builds), local setup, Litium Cloud deployment, data modelling and product fields, Litium Admin, Storefront GraphQL, Connect, and Extension Management APIs, or forum.litium.com solutions. Covers @litiumab/platform-extension-sdk extensions in React, Vue, Angular, or Vanilla: scaffolding, extension.manifest.json, window.litiumExtension, sub-path routing, IIFE/Vite builds, testing, installation, and deployment. Triggers: build Litium site, create Litium project, product field, block, accelerator, Litium API, wishlist, cart, placeOrder, custom field, backoffice extension, platform-extension-sdk, UI extension, panel, or settings page extension."
---
